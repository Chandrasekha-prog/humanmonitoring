...
model_performance = {}
sensor_data_buffer = []
BUFFER_SIZE = 50  # Number of readings before making a prediction

def load_and_train_models():
    """Load data and train multiple models"""
    global models, label_encoder, feature_names, mean_values, feature_importance, X_train, y_train, scaler, selector, selected_features, model_performance
    ...
    return models, label_encoder, feature_names, mean_values, feature_importance, X_train

# Load models when app starts
print("🚀 Starting application...")
models, label_encoder, feature_names, mean_values, feature_importance, X_train = load_and_train_models()
